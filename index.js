...
//
const BotName = 'XONTOL BOT'; // jangan di ubah...bila di ubah eror.      BOT BY MASLENT 
const instagramlu = 'https://instagram.com/IndraFajri64'; // jangan di ubah...bila di ubah eror
const whatsapplu = 'wa/me +62 852-2608-7964'; // jangan di ubah...bila di ubah eror
const kapanbotaktif = 'serahku'; // jangan di ubah...bila di ubah eror
const grupch1 = 'https://chat.whatsapp.com/J3jbu1Bo72CAUYNMGm6wbA'; // jangan di ubah...bila di ubah eror
const grupch2 = 'https://chat.whatsapp.com/KvnrobWpHgXEKqYwzQMTTi'; // jangan di ubah...bila di ubah eror
//
const
{
   WAConnection,
